...
import { useNavigate } from "react-router-dom"; // 1etap

function CreateRoute() {
  const [titleInp, setTitleInp] = useState("");
  const [descInp, setDescInp] = useState("");
  let navigate = useNavigate(); // 2etap
...
// get qilish uchun useEffect hook-ini ishlataman
// put qilish uchun, oldin get qilaman keyin put qilaman
